...
document.addEventListener('DOMContentLoaded', function () {
    var suggestionList = [
        ...
        "Ao empacotar um Limite de conta, validar se os registros contábeis correspondentes são gerados corretamente.",
        "Ao desejar realizar a contratação do consignado, seguir o fluxo padrão e assegurar que todas as verificações sejam realizadas conforme as políticas internas.",
        "Ao ter saldo futuro, realizar uma simulação para validar a consistência do sistema nas projeções de contratação futura.Validação BRUG0742 Termo do Seguro CDC 86 5123 com seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 7018 SEM seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 7019 com seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 5148 com seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 5120 com seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 7018 com seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 5123 SEM seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 7019 SEM seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 5148 SEM seguro PJ",
        "Validação BRUG0742 Termo do Seguro CDC 86 5120 SEM seguro PJ",
        "Contratação CDC 86 5123 PJ com seguro prestamista TFC",
        "Contratação CDC 86 7019 PJ com seguro prestamista TFC",
        "Contratação CDC 86 5148 PJ com seguro prestamista TFC",
        "Contratação CDC 86 5120 PJ com seguro prestamista TFC",
        "Contratação CDC 86 7018 PJ com seguro prestamista TFC",
        "Contratação CDC 86 5123 PJ SEM seguro prestamista TFC",
        "Contratação CDC 86 7019 PJ SEM seguro prestamista TFC",
        "Contratação CDC 86 5148 PJ SEM seguro prestamista TFC",
        "Contratação CDC 86 5120 PJ SEM seguro prestamista TFC",
        "Contratação CDC 86 7018 PJ SEM seguro prestamista TFC",
        "Contratação CDC 86 5123 PJ Socio maior 75 anos com seguro prestamista TFC",
        "Contratação CDC 86 7019 PJ Socio maior 75 anos com seguro prestamista TFC",
        "Contratação CDC 86 5148 PJ Socio maior 75 anos com seguro prestamista TFC",
        "Contratação CDC 86 5120 PJ Socio maior 75 anos com seguro prestamista TFC",
        "Contratação CDC 86 7018 PJ Socio maior 75 anos com seguro prestamista TFC",
        "Contratação CDC 86 5123 PJ Socio menor 18 anos com seguro prestamista TFC",
        "Contratação CDC 86 7019 PJ Socio menor 18 anos com seguro prestamista TFC",
        "Contratação CDC 86 5148 PJ Socio menor 18 anos com seguro prestamista TFC",
        "Contratação CDC 86 5120 PJ Socio menor 18 anos com seguro prestamista TFC",
        "Contratação CDC 86 7018 PJ Socio menor 18 anos com seguro prestamista TFC",
        "Estorno da formalização 86 5123 PJ TFC",
        "Estorno da formalização 86 7019 PJ TFC",
        "Estorno da formalização 86 5148 PJ TFC",
        "Estorno da formalização 86 5120 PJ TFC",
        "Estorno da formalização 86 7018 PJ TFC",
        "Estorno da formalização 86 5125 PF TFC",
        "Contratação CDC 86 5134 PF com seguro prestamista TFC",
        "Contratação CDC 86 5126 PF com seguro prestamista TFC",
        "Contratação CDC 86 5125 PF com seguro prestamista TFC",
        "Contratação CDC 86 5122 PF com seguro prestamista TFC",
        "Inclusão do seguro prestamista no CDC PJ",
        "Que entro no TFC em proposta de credito PF- proposta- De operação PO dou inicio a contratação",
        "Chegar na negociação o botão incluir seguro prestamista deve estar habilitado. Fazer a opção por seguro.",
        "A inclusão do seguro deverá ser efetivada com sucesso e após a formalização na consulta contrato deverá vir o campo 'solicitações de seguro' preenchido como ativo."
    ];
